...
import WarehouseHierarchyView from './pages/Inventory/WarehouseHierarchyView'
import BatchesManagementPage from './pages/Inventory/BatchesManagementPage'
    ...
    <>
      ...
      <Routes>
        ...
        >
          ...
          <Route path="catalog/products/import" element={<AddProduct />} />
          <Route path="products/import" element={<AddProduct />} />
